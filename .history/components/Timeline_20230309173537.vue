<template>
    <div class="container py-24">
        <div class="flex gap-x-14 relative" ref="scrollEl">
            <div class="bar h-[calc(100vh-100px)] sticky top-[100px] w-5 min-w-[1.25rem] bg-white rounded-full">
                <div class="bar-progress h-full bg-black origin-top"></div>
            </div>
...
onMounted(() => {
    scroll(animate('.bar-progress', { scaleY: [0, 1], transformOrigin: 'top'}), 
